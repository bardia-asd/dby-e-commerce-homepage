...
export default function Page() {
  ...
  return <main dir="rtl" id="top">
    ...
    <CartDrawer />
    <MobileNavDrawer />
    <header className="site-header"><button className="mobile-menu" onClick={openMenu} aria-label="باز کردن منو"><Menu size={20} /></button><div className="logo">DBY</div><nav><a href="#categories">دسته‌بندی‌ها</a><a href="#new">تازه‌ها</a><a href="#collections">کالکشن‌ها</a><a href="#best">پرفروش‌ها</a><a href="#about">درباره ما</a></nav><div className="header-actions"><button className="header-icon" onClick={openSearch} aria-label="باز کردن جستجو"><Search size={18} /></button><UserRound size={18} /><Heart size={18} /><button className="header-icon cart-trigger" onClick={openCart} aria-label="باز کردن سبد خرید"><ShoppingBag size={18} /><span className="cart-count">{cartCount || ''}</span></button></div></header>
